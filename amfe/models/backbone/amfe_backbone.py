...
class AMFEBackbone(nn.Module):
    ...
    def __init__(self, in_channels: int = 3, *, msb_variant: str = MSB.SUPPORTED_VARIANT) -> None:
        super().__init__()
        self.in_channels = in_channels
        self.msb_variant = msb_variant

        self.stem = DPSStem(in_channels=in_channels, out_channels=64)
    ...
    def forward(self, x: Tensor) -> tuple[Tensor, Tensor, Tensor]:
        ...
        s2 = self.stem(x)  # S2 [B, 64, H/4, W/4]
